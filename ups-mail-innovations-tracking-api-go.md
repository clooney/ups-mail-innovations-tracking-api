UPS Mail Innovations Tracking API - Go
================================
Use Go to track UPS Mail Innovations shipments with UPS Mail Innovations Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    func main() {
      ...
      params := trackingmore.CreateTrackingParams{
        TrackingNumber: "92612903104062543400000915",
        CourierCode:    "ups-mi",
      }      
